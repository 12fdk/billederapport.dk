...
- Brand column carries the legal identity (`.footer-org`): "12F ApS · CVR 45362957", the address and `mailto:support@billederapport.dk`. Keep this on every page.
- Footer-bottom band separated by a border, `0.825rem` text — copyright + "Bygget af [12F.dk](https://www.12f.dk/)" credit left; Privatlivspolitik · Handelsbetingelser · "Hostet i EU · GDPR-venlig" right.
